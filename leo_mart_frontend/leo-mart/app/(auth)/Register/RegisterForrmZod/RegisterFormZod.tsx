    ...
    <main className="min-h-screen flex items-center justify-center bg-[#F5F5F5] px-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white border border-gray-200 rounded-md shadow-sm p-6">
          ...
          {successMsg && (
            <div className="bg-green-50 text-green-600 border border-green-200 text-xs px-3 py-2 rounded-sm mb-4 text-center">
              {successMsg}
            </div>
          )}
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="flex flex-col">
                <label className="text-sm text-gray-700 mb-2">Confirm</label>
                <div className="relative">
                  <input
